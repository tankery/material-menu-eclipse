...
public class MaterialMenuIconCompat extends MaterialMenuBase {
    ...
    public MaterialMenuIconCompat(Activity activity, int color, Stroke stroke) {
        super(activity, color, stroke);
    }

    public MaterialMenuIconCompat(Activity activity, int color, Stroke stroke, int transformDuration) {
        super(activity, color, stroke, transformDuration);
    }

    public MaterialMenuIconCompat(Activity activity, int color, Stroke stroke, int transformDuration, int pressedDuration) {
